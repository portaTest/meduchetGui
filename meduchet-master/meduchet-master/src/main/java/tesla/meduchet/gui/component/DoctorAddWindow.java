...
public class DoctorAddWindow extends Window {
    ...
    @PropertyId("specialisation")
    private ComboBox specialisationField;
    @PropertyId("work")
    ...
    private DoctorAddWindow(final User user,
       ...
       private Component buildProfileTab() {
        ...
        root.setCaption("Добавление врача в базу данных");
        ...
        Label lblHeader = new Label("Введите данные о враче");
        ...
        specialisationField = new ComboBox("Специализация:");
        specialisationField.setInputPrompt("Укажите специализацию");
        specialisationField.addItem("МРТ");
        specialisationField.addItem("КТ");
        specialisationField.addItem("УЗИ");
        specialisationField.setNewItemsAllowed(true);
        details.addComponent(specialisationField);
        
        workField = new TextField("Work:");
        details.addComponent(workField);
        
        balanceField = new TextField("Баланс:");
        balanceField.setWidth("100%");
        balanceField.setNullRepresentation("");
        details.addComponent(balanceField);
    ...
    public static void open(final User user, final boolean preferencesTabActive) {
        ...
        Window w = new DoctorAddWindow(user, preferencesTabActive);
